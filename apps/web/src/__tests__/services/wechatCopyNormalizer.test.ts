...
describe("wechatCopyNormalizer", () => {
  it("strips only copy metadata from copied container", () => {
    ...
    container.innerHTML =
      '<section id="easymd"><p data-tool="easymd编辑器" data-source="x">A<span id="easymd">inner</span></p><h1 data-tool="easymd编辑器" data-kind="title">B</h1><code data-any="1" data-easymd-counter-generated="before">C</code></section>';

    stripCopyMetadata(container);

    expect(container.querySelectorAll("#easymd")).toHaveLength(1);
    expect(container.innerHTML).not.toContain("data-tool=");
    expect(container.innerHTML).not.toContain("data-easymd-counter-generated=");
  ...
  it("converts #easymd root section to div and strips only transparent root background styles", () => {
    const container = document.createElement("div");
    container.innerHTML =
      '<section id="easymd" style="background: transparent; background-color: transparent; color: rgb(9, 9, 9);"><p style="margin-top:18px; background-color: transparent;">A</p><p style="background: rgb(1, 2, 3);">B</p></section>';
  ...
  it("relocates root horizontal padding to direct children", () => {
    const container = document.createElement("div");
    container.innerHTML =
      '<section id="easymd" style="padding: 0px 16px; color: rgb(9, 9, 9);"><p>A</p><p>B</p></section>';
  ...
  it("keeps blockquote inner padding and relocates root horizontal padding via margin", () => {
    const container = document.createElement("div");
    container.innerHTML =
      '<section id="easymd" style="padding: 0px 16px;"><blockquote style="padding: 12px 10px;"><p>A</p></blockquote></section>';
  ...
  it("keeps callout inner padding and relocates root horizontal padding via margin", () => {
    const container = document.createElement("div");
    container.innerHTML =
      '<section id="easymd" style="padding: 0px 16px;"><section class="callout callout-note" style="padding: 12px 16px;"><div class="callout-title">Note</div><p>内容</p></section></section>';
  ...
  it("keeps pre inner padding and relocates root horizontal padding via margin", () => {
    const container = document.createElement("div");
    container.innerHTML =
      '<section id="easymd" style="padding: 0px 16px;"><pre style="padding: 10px 12px; background: rgb(30,30,30);"><code>console.log(1)</code></pre></section>';
  ...
  it("keeps heading inner padding and relocates root horizontal padding via margin", () => {
    const container = document.createElement("div");
    container.innerHTML =
      '<section id="easymd" style="padding: 0px 16px;"><h3 style="padding-left: 8px; border-left: 4px solid rgb(0, 87, 255);"><span class="content">标题</span></h3></section>';
  ...
  it("relocates root horizontal padding to hr via margin", () => {
    const container = document.createElement("div");
    container.innerHTML =
      '<section id="easymd" style="padding: 0px 16px;"><hr style="border-top: 1px solid rgb(238, 238, 238);" /></section>';
  ...
  it("keeps hr auto margins when relocating root horizontal padding", () => {
    const container = document.createElement("div");
    container.innerHTML =
      '<section id="easymd" style="padding: 0px 16px;"><hr style="width: 20%; margin-left: auto; margin-right: auto; border-top: 1px solid rgb(238, 238, 238);" /></section>';
  ...
  it("falls back to root padding when heading margin uses auto keyword", () => {
    const container = document.createElement("div");
    container.innerHTML =
      '<section id="easymd" style="padding: 0px 16px;"><h3 style="margin-left: auto; margin-right: auto; padding-left: 8px;"><span class="content">标题</span></h3></section>';
  ...
  it("normalizes figure background without overriding explicit figure background", () => {
    const container = document.createElement("div");
    container.innerHTML =
      '<section id="easymd"><figure><img src="x.png" alt="x" /><figcaption>cap</figcaption></figure><figure style="background:#f5f5f5;"><img src="y.png" alt="y" /></figure></section>';
  ...
  it("normalizes list item section background without overriding explicit section background", () => {
    const container = document.createElement("div");
    container.innerHTML =
      '<section id="easymd"><ul><li><section>A</section></li><li><section style="background-color:#f5f5f5;">B</section></li></ul></section>';
  ...
  it("normalizes list container background without overriding explicit list background", () => {
    const container = document.createElement("div");
    container.innerHTML =
      '<section id="easymd"><ul><li><section>A</section></li></ul><ol style="background-color:#f5f5f5;"><li><section>B</section></li></ol></section>';
  ...
  it("keeps explicit list background-image untouched", () => {
    const container = document.createElement("div");
    container.innerHTML =
      '<section id="easymd"><ul style="background-image:linear-gradient(#111,#222);"><li><section>A</section></li></ul></section>';
  ...
  it("strips root transparent background written in modern color syntax", () => {
    const container = document.createElement("div");
    container.innerHTML =
      '<section id="easymd" style="background: #0000; background-color: rgb(0 0 0 / 0); color: rgb(1, 1, 1);"><p>A</p></section>';
  ...
  it("does not override background of elements inside blockquote with explicit background", () => {
    const container = document.createElement("div");
    container.innerHTML =
      '<section id="easymd" style="background-color: rgb(255, 255, 255);"><blockquote style="background-color: rgb(200, 200, 200);"><p>引用文字</p></blockquote><p>普通文字</p></section>';

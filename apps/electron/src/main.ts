...
app.setName('EASYMD');
app.setAppUserModelId('com.easymd.app');
...
function createWindow() {
    ...
    console.log('[EASYMD] Loading URL:', startUrl);
    console.log('[EASYMD] isDev:', isDev);
    console.log('[EASYMD] resourcesPath:', process.resourcesPath);
    ...
    const template: Electron.MenuItemConstructorOptions[] = [
        ...
        },
        {
            ...
            submenu: [
                ...
                {
                    label: '访问官网',
                    click: () => shell.openExternal('https://easymd.app'),
                },
                {
                    label: 'GitHub 仓库',
                    click: () => shell.openExternal('https://github.com/tenngoxars/EASYMD'),
                },
            ],
        },
    ];

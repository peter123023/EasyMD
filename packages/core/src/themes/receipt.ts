...
#easymd table tr th:first-child {
    text-align: left;
}
...
#easymd table tr td:first-child {
    text-align: left;
}
...
#easymd .callout-note { border-left: 2px dashed #000; }
#easymd .callout-tip { border-left: 2px dashed #000; }
#easymd .callout-important { border-left: 2px dashed #000; }
#easymd .callout-warning { border-left: 2px dashed #000; }
#easymd .callout-caution { border-left: 2px dashed #000; }

...
#easymd pre code.hljs .hljs-subst {
    color: #FF7B72;
    /* 亮红橙色关键字 */
    font-weight: bold;
}
...
#easymd pre code.hljs .hljs-variable,
#easymd pre code.hljs .hljs-template-variable {
    color: #79C0FF;
    /* 亮蓝色数字和变量 */
}
...
#easymd pre code.hljs .hljs-selector-id {
    color: #D2A8FF;
    /* 亮紫色函数名 */
    font-weight: bold;
}

#easymd pre code.hljs .hljs-type,
#easymd pre code.hljs .hljs-class .hljs-title {
    color: #FFA657;
    /* 橙色类型，提高对比度 */
    font-weight: bold;
}

#easymd pre code.hljs .hljs-tag,
#easymd pre code.hljs .hljs-name,
#easymd pre code.hljs .hljs-attribute {
    color: #79C0FF;
    /* 亮蓝色标签 */
}

#easymd pre code.hljs .hljs-regexp,
#easymd pre code.hljs .hljs-link {
    color: #56D4DD;
    /* 亮青色正则表达式 */
}

#easymd pre code.hljs .hljs-symbol,
#easymd pre code.hljs .hljs-bullet {
    color: #FF7B72;
    /* 亮红橙色符号 */
}
...
#easymd pre code.hljs .hljs-meta {
    color: #8B949E;
    /* 元数据用灰色 */
    font-weight: bold;
}

#easymd pre code.hljs .hljs-deletion {
    background: rgba(255, 123, 114, 0.2);
    /* 删除线背景 */
    color: #FF7B72;
}

#easymd pre code.hljs .hljs-addition {
    background: rgba(121, 192, 255, 0.2);
    /* 添加线背景 */
    color: #79C0FF;
}

#easymd pre code.hljs .hljs-emphasis {
    font-style: italic;
    color: #E6EDF3;
}

#easymd pre code.hljs .hljs-strong {
    font-weight: bold;
    color: #FF7B72;
}
...
#easymd .katex-block svg,
#easymd mjx-container[display="true"] svg {
    max-width: 100% !important;
}

#easymd .inline-equation svg,
#easymd .katex-inline svg,
#easymd mjx-container:not([display="true"]) svg {
    max-width: 100%;
